...
const galleryImages = [
  { src: 'images/events/wedding.jpg',       alt: 'Grand Wedding Ceremony',      category: 'wedding' },
  { src: 'images/events/haldi.jpg',         alt: 'Haldi Ceremony',              category: 'wedding' },
  { src: 'images/events/valaikappu.jpg',    alt: 'Valaikappu Function',         category: 'wedding' },
...
function initGallery() {
  ...
  filterBtns.forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      filteredImages = activeFilter === 'all' ? [...galleryImages] : galleryImages.filter(img => img.category === activeFilter);
